...
from scripts.train_model_v2 import ModelTrainer
...
def main():
    ...
    X, y = model_trainer.prepare_data(data, False, False, prepare_training_data=True)  # todo change to False when making final predictions
    # y = np.log1p(y)
